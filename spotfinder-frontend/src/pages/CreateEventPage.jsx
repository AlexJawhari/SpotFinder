...
const CreateEventPage = () => {
    ...
    return (
        <div className="container mx-auto px-4 py-8 max-w-2xl">
            <h1 className="text-3xl font-bold bg-gradient-to-r from-[#4FC3F7] via-[#66BB6A] to-[#26C6DA] bg-clip-text text-transparent mb-2">Create Event</h1>
            <p className="text-slate-600 mb-6">Organize a meetup, study session, or social gathering</p>
